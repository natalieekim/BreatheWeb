...
const dcl = e => {
    ...
    convertArrayToCsv = (e, t, n) => {
        let r, o, l, a, i, d = "",
            s = [];
        for (r = getDateDiffDays(t, n), s = getDatesSparse(t, r), o = Object.keys(e)
            .sort(), d = "Domain," + s.join(",") + "\n", l = 0; l < o.length; l++) {
    ...
    getAvailableElementWidth = e => {
        let t = 0;
        return t += parseInt(window.getComputedStyle(e)
            .getPropertyValue("width")), t -= parseInt(window.getComputedStyle(e)
            .getPropertyValue("padding-left")), t -= parseInt(window.getComputedStyle(e)
            .getPropertyValue("padding-right")), t -= parseInt(window.getComputedStyle(e)
            .getPropertyValue("border-left-width")), t -= parseInt(window.getComputedStyle(e)
            .getPropertyValue("border-right-width")), t
    };